...
const api = {
  ...
  createWallet: async (userId) => {
    ...
    return {
      ...
      wallet: { id: crypto.randomUUID(), userId, balance: 0 },
    };
  },
  getUserWallet: async (userId) => {
    ...
    if (userId) {
      return {
        success: true,
        wallet: { id: "wallet456", userId: "user123", balance: 1000 },
      }; // Mock data
    }
    return { success: false, message: "Wallet not found" };
  },
  transferFunds: async (senderWalletId, receiverWalletId, amount) => {
  ...
  createVirtualCard: async (walletId) => {
  ...
  getUserVirtualCard: async (walletId) => {
    await new Promise((resolve) => setTimeout(resolve, 300));
    if (walletId) {
      return {
        success: true,
...
const WalletApp = () => {
  ...
  const [activeTab, setActiveTab] = useState("login"); // 'login', 'register', 'wallet'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="grid w-full grid-cols-2 bg-gray-800 border border-gray-700">
            <button
              value="login"
              onClick={() => setActiveTab("login")}
              className={cn(
                "text-gray-300 data-[state=active]:text-white data-[state=active]:bg-gray-700",
                    ...
                    <div className="p-4 space-y-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="bg-gray-700 text-white border-gray-600 placeholder:text-gray-400 w-full px-4 py-2 rounded-md"
                        />
                      </div>
                      <div className="space-y-2">
                        <label
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <input
                        ...
                        className="bg-gray-700 text-white border-gray-600 placeholder:text-gray-400 px-4 py-2 rounded-md"
                      />
                      <input
                        type="number"
                        name="amount"
                  ...
                  <div className="space-y-4">
                    ...
                    {virtualCard ? (
                      <div className="bg-gray-700 border-gray-600 p-4 rounded-md">
                      ...
                      <button
                        ...
                        className="w-full bg-purple-500 text-white hover:bg-purple-600 py-2 rounded-md"
                        disabled={loading}
                      >
                ...
                <p className="text-gray-400">
                  No wallet found. A wallet is automatically created upon
